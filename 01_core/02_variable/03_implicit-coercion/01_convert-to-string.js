...
개발자가 의도적으로 값의 타입 변환하는 것을 명시적 타입 변환 (explicit coercion)이라고 하며
자바스크립트 엔진에 의해 암묵적으로 자동 변환되는 것을 암묵적 타입 변환(implicit coercion)이라고 한다.
-> 암묵적 타입 변환은 드러나지 않으므로 예측이 가능해야 오류를 방지할 수 있다.
*/
